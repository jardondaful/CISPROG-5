...
def createBank(numAccounts = 1):
    names = ("Amy", "Jake", "Hitchcock", "Mark", "Kayla",
"Ken", "Jill", "Jack")
    bank = Bank()
...
def testAccount():
  ...
  print("Balance after attempting to deposit $100:", account.getBalance())
  print(account.deposit(-50))
  print("Balance after attempting to deposit -$50:", account.getBalance())
  print(account.withdraw(100))
  print("Balance after attempting to withdraw $100:", account.getBalance())
  print(account.withdraw(-50))
  print("Balance after attempting to withdraw - $50:", account.getBalance())
  print(account.withdraw(100000))
  print("Balance after attempting to withdraw $100000:", account.getBalance())
  print("")
